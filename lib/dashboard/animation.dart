import 'dart:io';
import 'package:dummy/dashboard/details.dart';
import 'package:dummy/dashboard/network_image.dart';
import 'package:flutter/material.dart';
import 'package:flutter_swiper_null_safety/flutter_swiper_null_safety.dart';
import 'package:dummy/dashboard/assets.dart' as assets;

List<String> images = [assets.images[0], assets.images[1], assets.images[2]];
...
class AnimationOnePage extends StatefulWidget {
  static const String path = "lib/dashboard/animation.dart";
                          ...
                          onTap:
                              () => Navigator.push(
                                ...
                                PageRouteBuilder(
                                  ...
                                  pageBuilder:
                                      (_, __, ___) =>
                                          AnimationOneDetails(index: index),
                                ),
                              ),
                          child: Hero(
                            tag: "image$index",
