...
class FlyingWidget extends StatefulWidget {
  @override
  _FlyingWidgetState createState() => _FlyingWidgetState();
}
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Center(
            child: Text("STORE", style: TextStyle(color: Colors.grey[500])),
          ),
          actions: <Widget>[Icon(Icons.search, color: Colors.grey)],
        ),
        body: Container(
