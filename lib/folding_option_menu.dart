...
class FoldingOptionMenu extends StatefulWidget {
  @override
  _FoldingOptionMenuState createState() => _FoldingOptionMenuState();
}

class _FoldingOptionMenuState extends State<FoldingOptionMenu> {
  @override
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Align(alignment: Alignment.centerRight, child: FoldableOptions()),
          ],
        ),
      ),
    );
