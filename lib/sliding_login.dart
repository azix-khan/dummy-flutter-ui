...
class SlidingLogin extends StatefulWidget {
  @override
  SlidingLoginState createState() {
    return SlidingLoginState();
  }
}

class SlidingLoginState extends State<SlidingLogin>
      ...
      body: Stack(
        children: <Widget>[
          ...
          Align(
            ...
            child: Container(
              color:
                  isLogin && !loginController.isAnimating
                      ? Colors.white
                      : Colors.transparent,
              width: MediaQuery.of(context).size.width,
